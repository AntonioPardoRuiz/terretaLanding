  ...
  readonly services: readonly Service[] = [
    {
      ...
      description: 'Creamos plataformas web a medida para mejorar procesos internos, gestionar operaciones, conectar equipos o dar mejor servicio a clientes y usuarios. Diseñamos soluciones funcionales, seguras y escalables, adaptadas a la realidad de tu empresa.',

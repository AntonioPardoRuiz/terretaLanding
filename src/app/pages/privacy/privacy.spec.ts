...
describe('PrivacyComponent', () => {
  it('renders the legal document with one H1 and nine accessible sections including candidatures', async () => {
    ...
    expect(element.querySelectorAll('.legal-layout article > section')).toHaveLength(9);
